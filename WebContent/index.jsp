	...
	<form id="get_bundle" action="BundleServlet" method="post">
		<table>
			<tbody>
				...
				<tr><td>Input:</td><td><input id="input" type="text" /></td></tr>
				<tr><td>Output:</td><td><input id="output" type="text" /></td></tr>
			</tbody>
		</table>
		<input id="service_description" name="service_description" type="hidden" />
		<p><input id="submit_btn" value="Submit" type="button"/><span id="msg"/></p>
	</form>
</body>
</html>